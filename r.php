...
<head>
	...
	<link rel="shortcut icon" href="images/tekhive-favicon-300x300.png" />
	...
	<link rel="stylesheet" href="custom_home.css" />
...
<body data-mobile-nav-trigger-alignment="right" data-mobile-nav-align="left" data-mobile-nav-style="modern" data-mobile-nav-shceme="gray" data-mobile-header-scheme="gray" data-mobile-nav-breakpoint="1199">
					...
					<div class="mainbar">
						<div class="row mainbar-row align-items-lg-stretch px-4">
								...
								<div class="navbar-header">
									<a class="navbar-brand" href="index.html" rel="home">
										<span class="navbar-brand-inner">
											<img class="logo-dark" src="./assets/img/logo/tekhive.png" alt="Ave HTML Template" style="height:80%;">
											<img class="logo-sticky" src="./assets/img/logo/tekhive.png" alt="Ave HTML Template" style="height:70%; margin-top:5%;">
											<img class="mobile-logo-default" src="./assets/img/logo/tekhive.png" alt="Ave HTML Template" style="height:80%;">
											<img class="logo-default" src="./assets/img/logo/tekhive.png" alt="Ave HTML Template" style="height:80%; margin-top:4%;">
										</span>
									</a>
							...
							<div class="col">
								...
								<div class="collapse navbar-collapse nav_color" id="main-header-collapse">
									
									<ul id="" class="main-nav nav align-items-lg-stretch justify-content-lg-start" data-submenu-options='{ "toggleType":"fade", "handler":"mouse-in-out" }' data-localscroll="true">
	...
	<main id="content" class="content">
		...
		<section class="vc_row fullheight d-flex flex-wrap align-items-center pb-50" style="background-image: url('');">
			...
			<div class="container">
				<div class="row d-flex flex-wrap align-items-center">
					...
					<div class="lqd-column col-lg-5 col-md-6 lqd-column" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":"all-childs","duration":1200,"delay":100,"initValues":{"translateY":51,"opacity":0},"animations":{"translateY":0,"opacity":1}}' style="padding-top: 10%;">
						...
						<div class="ld-fancy-heading mask-text">
							...
							<img src="./assets/img/logo/tekhive.png">-->
						...
						<div class="row">
							...
							<div class="lqd-column col-sm-6 mb-3 mb-md-0 explore_button">
								...
								<a href="#" class="btn btn-solid text-uppercase circle btn-bordered border-thin font-size-14 font-weight-semibold" data-localscroll="true" data-localscroll-options='{"scrollBelowSection":true}'>
									<span>
										<span class="btn-txt">Explore Tekhive</span>
									</span>
								</a>
								...
								<div class="ld-fancy-heading">
									<p>
										<span class="ld-fh-txt">
											<strong><span class="text_custom">Call us +880 17 555 000 64</span></strong>
											<br>
					...
					<div class="lqd-column col-lg-7 col-md-6 hidden-xs hidden-sm hidden-md">
						...
						<div class="ld-masked-image" data-dynamic-shape="true">
							...
							<figure class="clip-svg" data-responsive-bg="true" style="clip-path: url(#masked-image-1); -webkit-clip-path: url(#masked-image-1);">
								<img src="images/banner_1.jpg" alt="Image">
							</figure>
						</div><!-- /ld-masked-image -->
				...
				<div class="row">
					...
					<div class="lqd-column col-lg-6">
						...
						<header class="fancy-title" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":"all-childs","duration":1200,"delay":100,"easing":"easeOutQuint","direction":"forward","initValues":{"translateX":-32,"opacity":0},"animations":{"translateX":0,"opacity":1}}'>
							...
							<h6 class="text-uppercase ltr-sp-2 font-size-12 font-weight-semibold text-secondary text_custom">About Tekhive</h6>
							<h2 class="mt-md-4 pr-md-7 mb-4">What We Do</h2>
							...
							<div class="row">
								...
								<div class="lqd-column col-xs-4 col-sm-2 pt-3 mb-4">
									...
									<div class="lqd-h-sep">
										<span class="lqd-h-sep-inner sep_inner_color"></span><!-- /.lqd-h-sep-inner -->
									</div><!-- /.lqd-h-sep -->
	
								</div><!-- /.col-sm-2 -->
	
								<div class="lqd-column col-sm-10 col-xs-12">
									<p>We take care of the technology part of your Business, So that you can Focus on your doing what you do best for your clients.</p>
								</div><!-- /.col-sm-10 -->
		...
		<section class="vc_row pt-80 pb-120" id="works">
			<div class="container">
				<div class="row">
					<h2 class="col-12" style="text-align:center;">OUR LATEST WORK</h2>
					<div class="lqd-column col-6 col-offset-3" style="text-align:center;">
						<p>We take care of the technology part of your Business, So that you can Focus on your doing what you do best for your clients.</p>
					</div><br>
										...
										<div class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid title-size-32 ld-pf-semiround">
											...
											<div class="ld-pf-inner">
												...
												<div class="ld-pf-image">
													<figure style="background-image: url('images/sin-thumb-400x400.jpg');">
														<img src="images/sin-thumb-400x400.jpg" alt="Portfolio Image">
													</figure>
												</div><!-- /.ld-pf-image -->
												...
												<div class="ld-pf-details" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": ".split-inner", "duration": 200, "delay": 35, "offDuration": 100, "easing": "easeOutCubic", "initValues": { "translateX": 50, "rotateZ": -75, "opacity": 0, "transformOrigin": [0, "-100%", 0] }, "animations": { "translateX": 0, "rotateZ": 0, "opacity": 1, "transformOrigin": [0, "0%", 0] } }'>
													<div class="ld-pf-details-inner">
														<h3 class="ld-pf-title h4 font-weight-semibold" data-split-text="true" data-split-options='{ "type": "chars" }'>SINHWEE MOTOR</h3>
													</div><!-- /.ld-pf-details-inner -->
												</div><!-- /.ld-pf-details -->
												
												<a href="#" target="_blank" class="liquid-overlay-link"></a>
									...
									<div class="lqd-column col-md-4 col-sm-6 col-xs-12 masonry-item">
										...
										<div class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid title-size-32 ld-pf-semiround">
											...
											<div class="ld-pf-inner">
												...
												<div class="ld-pf-image">
													<figure style="background-image: url('images/lira-thumb-400x400.jpg');">
														<img src="images/lira-thumb-400x400.jpg" alt="Portfolio Image">
													</figure>
												</div><!-- /.ld-pf-image -->
												...
												<div class="ld-pf-details" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": ".split-inner", "duration": 200, "delay": 35, "offDuration": 100, "easing": "easeOutCubic", "initValues": { "translateX": 50, "rotateZ": -75, "opacity": 0, "transformOrigin": [0, "-100%", 0] }, "animations": { "translateX": 0, "rotateZ": 0, "opacity": 1, "transformOrigin": [0, "0%", 0] } }'>
													<div class="ld-pf-details-inner">
														<h3 class="ld-pf-title h4 font-weight-semibold" data-split-text="true" data-split-options='{ "type": "chars" }'>LIRA HOMES</h3>
													</div><!-- /.ld-pf-details-inner -->
												</div><!-- /.ld-pf-details -->
										...
										<div class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid title-size-32 ld-pf-semiround">
											...
											<div class="ld-pf-inner">
												...
												<div class="ld-pf-image">
													...
													<figure style="background-image: url('images/allthatdori.jpg');">
														<img src="images/allthatdori.jpg" alt="Portfolio Image">
													</figure>
												</div><!-- /.ld-pf-image -->
												...
												<div class="ld-pf-details" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": ".split-inner", "duration": 200, "delay": 35, "offDuration": 100, "easing": "easeOutCubic", "initValues": { "translateX": 50, "rotateZ": -75, "opacity": 0, "transformOrigin": [0, "-100%", 0] }, "animations": { "translateX": 0, "rotateZ": 0, "opacity": 1, "transformOrigin": [0, "0%", 0] } }'>
													<div class="ld-pf-details-inner">
														<h3 class="ld-pf-title h4 font-weight-semibold" data-split-text="true" data-split-options='{ "type": "chars" }'>DORI</h3>
													</div><!-- /.ld-pf-details-inner -->
												</div><!-- /.ld-pf-details -->
									...
									<div class="lqd-column col-md-4 col-sm-6 col-xs-12 masonry-item">
										...
										<div class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid title-size-32 ld-pf-semiround">
											...
											<div class="ld-pf-inner">
												...
												<div class="ld-pf-image">
													<figure style="background-image: url('images/Home-COMBAT-thumb-400x400.jpg');">
														<img src="images/Home-COMBAT-thumb-400x400.jpg" alt="Portfolio Image">
													</figure>
												</div><!-- /.ld-pf-image -->
												...
												<div class="ld-pf-details" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": ".split-inner", "duration": 200, "delay": 35, "offDuration": 100, "easing": "easeOutCubic", "initValues": { "translateX": 50, "rotateZ": -75, "opacity": 0, "transformOrigin": [0, "-100%", 0] }, "animations": { "translateX": 0, "rotateZ": 0, "opacity": 1, "transformOrigin": [0, "0%", 0] } }'>
													<div class="ld-pf-details-inner">
														<h3 class="ld-pf-title h4 font-weight-semibold" data-split-text="true" data-split-options='{ "type": "chars" }'>LINGJACK</h3>
													</div><!-- /.ld-pf-details-inner -->
												</div><!-- /.ld-pf-details -->
									...
									<div class="lqd-column col-md-4 col-sm-6 col-xs-12 masonry-item">
										...
										<div class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid title-size-32 ld-pf-semiround">
											...
											<div class="ld-pf-inner">
												...
												<div class="ld-pf-image">
													<figure style="background-image: url('images/Service-thumb-400x400.jpg');">
														<img src="images/Service-thumb-400x400.jpg" alt="Portfolio Image">
													</figure>
												</div><!-- /.ld-pf-image -->
												...
												<div class="ld-pf-details" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": ".split-inner", "duration": 200, "delay": 35, "offDuration": 100, "easing": "easeOutCubic", "initValues": { "translateX": 50, "rotateZ": -75, "opacity": 0, "transformOrigin": [0, "-100%", 0] }, "animations": { "translateX": 0, "rotateZ": 0, "opacity": 1, "transformOrigin": [0, "0%", 0] } }'>
													<div class="ld-pf-details-inner">
														<h3 class="ld-pf-title h4 font-weight-semibold" data-split-text="true" data-split-options='{ "type": "chars" }'>GENIOUS<br/>AIRCON</h3>
													</div><!-- /.ld-pf-details-inner -->
												</div><!-- /.ld-pf-details -->
									...
									<div class="lqd-column col-md-4 col-sm-6 col-xs-12 masonry-item">
										...
										<div class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid title-size-32 ld-pf-semiround">
											...
											<div class="ld-pf-inner">
												...
												<div class="ld-pf-image">
													<figure style="background-image: url('images/Santaaire-Air-Conditioning-thumb-400x400.jpg');">
														<img src="images/Santaaire-Air-Conditioning-thumb-400x400.jpg" alt="Portfolio Image">
													</figure>
												</div><!-- /.ld-pf-image -->
												...
												<div class="ld-pf-details" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": ".split-inner", "duration": 200, "delay": 35, "offDuration": 100, "easing": "easeOutCubic", "initValues": { "translateX": 50, "rotateZ": -75, "opacity": 0, "transformOrigin": [0, "-100%", 0] }, "animations": { "translateX": 0, "rotateZ": 0, "opacity": 1, "transformOrigin": [0, "0%", 0] } }'>
													<div class="ld-pf-details-inner">
														<h3 class="ld-pf-title h4 font-weight-semibold" data-split-text="true" data-split-options='{ "type": "chars" }'>MUNSHENG<br/>AIRCON</h3>
													</div><!-- /.ld-pf-details-inner -->
												</div><!-- /.ld-pf-details -->
									...
									<div class="lqd-column col-md-4 col-sm-6 col-xs-12 masonry-item">
										...
										<div class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid title-size-32 ld-pf-semiround">
											...
											<div class="ld-pf-inner">
												...
												<div class="ld-pf-image">
													<figure style="background-image: url('images/WAKANUI-Grill-Dining-2-400x400.jpg');">
														<img src="images/WAKANUI-Grill-Dining-2-400x400.jpg" alt="Portfolio Image">
													</figure>
												</div><!-- /.ld-pf-image -->
												...
												<div class="ld-pf-details" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": ".split-inner", "duration": 200, "delay": 35, "offDuration": 100, "easing": "easeOutCubic", "initValues": { "translateX": 50, "rotateZ": -75, "opacity": 0, "transformOrigin": [0, "-100%", 0] }, "animations": { "translateX": 0, "rotateZ": 0, "opacity": 1, "transformOrigin": [0, "0%", 0] } }'>
													<div class="ld-pf-details-inner">
														<h3 class="ld-pf-title h4 font-weight-semibold" data-split-text="true" data-split-options='{ "type": "chars" }'>WAKANUI</h3>
													</div><!-- /.ld-pf-details-inner -->
												</div><!-- /.ld-pf-details -->
									...
									<div class="lqd-column col-md-4 col-sm-6 col-xs-12 masonry-item">
										...
										<div class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid title-size-32 ld-pf-semiround">
											...
											<div class="ld-pf-inner">
												...
												<div class="ld-pf-image">
													<figure style="background-image: url('images/Sinlek-400x400.jpg');">
														<img src="images/Sinlek-400x400.jpg" alt="Portfolio Image">
													</figure>
												</div><!-- /.ld-pf-image -->
												...
												<div class="ld-pf-details" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": ".split-inner", "duration": 200, "delay": 35, "offDuration": 100, "easing": "easeOutCubic", "initValues": { "translateX": 50, "rotateZ": -75, "opacity": 0, "transformOrigin": [0, "-100%", 0] }, "animations": { "translateX": 0, "rotateZ": 0, "opacity": 1, "transformOrigin": [0, "0%", 0] } }'>
													<div class="ld-pf-details-inner">
														<h3 class="ld-pf-title h4 font-weight-semibold" data-split-text="true" data-split-options='{ "type": "chars" }'>SINLEK</h3>
													</div><!-- /.ld-pf-details-inner -->
												</div><!-- /.ld-pf-details -->
									...
									<div class="lqd-column col-md-4 col-sm-6 col-xs-12 masonry-item">
										...
										<div class="ld-pf-item ld-pf-light pf-details-inside pf-details-full pf-details-h-mid pf-details-v-mid title-size-32 ld-pf-semiround">
											...
											<div class="ld-pf-inner">
												...
												<div class="ld-pf-image">
													<figure style="background-image: url('images/Acomplis-Technology-Managed-IT-Services-400x400.jpg');">
														<img src="images/Acomplis-Technology-Managed-IT-Services-400x400.jpg" alt="Portfolio Image">
													</figure>
												</div><!-- /.ld-pf-image -->
												...
												<div class="ld-pf-details" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": ".split-inner", "duration": 200, "delay": 35, "offDuration": 100, "easing": "easeOutCubic", "initValues": { "translateX": 50, "rotateZ": -75, "opacity": 0, "transformOrigin": [0, "-100%", 0] }, "animations": { "translateX": 0, "rotateZ": 0, "opacity": 1, "transformOrigin": [0, "0%", 0] } }'>
													<div class="ld-pf-details-inner">
														<h3 class="ld-pf-title h4 font-weight-semibold" data-split-text="true" data-split-options='{ "type": "chars" }'>ACOMPLIS<br/>TECHNOLOGY</h3>
													</div><!-- /.ld-pf-details-inner -->
												</div><!-- /.ld-pf-details -->
				...
				<div class="row">
					...
					<div class="lqd-column col-md-10 col-md-offset-1">
						...
						<header class="fancy-title text-center mb-75" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":"all-childs","duration":1200,"delay":100,"initValues":{"translateY":80,"opacity":0},"animations":{"translateY":0,"opacity":1}}'>
							...
							<h6 class="text-uppercase ltr-sp-2 font-size-12 font-weight-semibold text-secondary text_custom">WE CHOOSE TEKHIVE</h6>
				...
				<div class="row" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":"all-childs","duration":"1200","delay":"180","initValues":{"scale":0.8,"opacity":0},"animations":{"scale":1,"opacity":1}}'>
					...
					<div class="lqd-column col-md-6">
						...
						<div class="iconbox iconbox-side iconbox-semiround iconbox-shadow iconbox-heading-sm iconbox-filled" id="ld_icon_box_5c4e9c4475e68" data-plugin-options='{"color":"#3d59e8"}'>
							<div class="iconbox-icon-wrap service_icon">
								<i class="fa fa-laptop"></i>
							</div><!-- /.iconbox-icon-container -->
							<div class="contents">
								<h3 class="mb-2">WEBSITE DESIGN & DEVELOPMENT</h3>
					...
					<div class="lqd-column col-md-6">
						...
						<div class="iconbox iconbox-side iconbox-semiround iconbox-shadow iconbox-heading-sm iconbox-filled" id="ld_icon_box_5c4e9c4475e69" data-plugin-options='{"color":"#28d5a7"}'>
							...
							<div class="contents">
								<h3 class="mb-2">MOBILE APPS DEVELOPMENT</h3>
								<p>Produce the highest quality work and services for every client, on every project</p>
							</div><!-- /.contents -->
						</div><!-- /.iconbox -->
					...
					<div class="lqd-column col-md-6">
						...
						<div class="iconbox iconbox-side iconbox-semiround iconbox-shadow iconbox-heading-sm iconbox-filled" id="ld_icon_box_5c4e9c4475e70" data-plugin-options='{"color":"#f9b851"}'>
							...
							<div class="contents">
								<h3 class="mb-2">CUSTOM APPLICATION DEVELOPMENT</h3>
								<p>Produce the highest quality work and services for every client, on every project</p>
							</div><!-- /.contents -->
						</div><!-- /.iconbox -->
					...
					<div class="lqd-column col-md-6">
						...
						<div class="iconbox iconbox-side iconbox-semiround iconbox-shadow iconbox-heading-sm iconbox-filled" id="ld_icon_box_5c4e9c4475e71" data-plugin-options='{"color":"#fe688b"}'>
							...
							<div class="contents">
								<h3 class="mb-2">E-COMMERCE SOLUTION</h3>
								<p>Produce the highest quality work and services for every client, on every project</p>
							</div><!-- /.contents -->
						</div><!-- /.iconbox -->
				...
				<div class="row d-flex flex-wrap align-items-center">
					...
					<div class="lqd-column col-lg-5 col-md-6 mb-5 mb-md-0" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":"all-childs","duration":1200,"delay":160,"initValues":{"translateY":50,"opacity":0},"animations":{"translateY":0,"opacity":1}}'>
						...
						<header class="fancy-title mb-60">
							...
							<h6 class="text-uppercase ltr-sp-2 font-size-12 font-weight-semibold text-secondary text_custom">HOW WE WORK</h6>
						...
						<a href="https://www.youtube.com/watch?v=QWGjLq1P3q4&feature=youtu.be" class="btn text-uppercase btn-icon-left btn-icon-xlg btn-icon-circle font-size-12 font-weight-semibold" style="background-color:#E57E25; border:0px; color: #fff;">
							<span>
					...
					<div class="lqd-column col-lg-6 col-md-5 col-md-offset-1">
						...
						<div class="liquid-img-group-single stretch-to-right" data-shadow-style="4" data-roundness="4" data-inview="true" data-animate-shadow="true" data-reveal="true" data-reveal-options='{"direction":"rl","bgcolor":"rgb(229, 127, 39)"}'>
							<div class="liquid-img-group-img-container">
								<div class="liquid-img-container-inner">
									<figure>
										<img  src="images/design-development-electronics-326424 (1).jpg" alt="Banner" />
									</figure>
								</div>
							</div>
						</div>
				...
				<div class="row d-flex flex-wrap align-items-center">
									...
									<div class="liquid-img-group-single" data-roundness="4">
										<div class="liquid-img-group-img-container">
											<div class="liquid-img-container-inner" data-parallax="true" data-parallax-from='{"translateY":47}' data-parallax-to='{"translateY":-74}' data-parallax-options='{"overflowHidden": false, "easing": "linear"}'>
												<figure>
													<img src="images/analysis-coffee-cup-1549702.jpg"  alt="Team Member"/>
												</figure>
									...
									<div class="liquid-img-group-single" data-roundness="4">
										<div class="liquid-img-group-img-container">
											<div class="liquid-img-container-inner" data-parallax="true" data-parallax-from='{"translateY":83}' data-parallax-to='{"translateY":-94}' data-parallax-options='{"overflowHidden": false, "easing": "linear"}'>
												<figure>
													<img src="images/apple.jpg" alt="Team Member"/>
												</figure>
											</div><!-- /.liquid-img-container-inner -->
										</div><!-- /.liquid-img-group-img-container -->
									</div><!-- /.liquid-img-group-single -->
									...
									<div class="liquid-img-group-single" data-roundness="4">
										<div class="liquid-img-group-img-container">
											<div class="liquid-img-container-inner" data-parallax="true" data-parallax-from='{"translateY":167}' data-parallax-to='{"translateY":-151}' data-parallax-options='{"overflowHidden": false, "easing": "linear"}'>
												<figure>
													<img src="images/developngcode.jpg"  alt="Team Member"/>
												</figure>
											</div><!-- /.liquid-img-container-inner -->
										</div><!-- /.liquid-img-group-img-container -->
									</div><!-- /.liquid-img-group-single -->
					...
					<div class="lqd-column col-md-6 col-md-offset-1"  data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":"all-childs","duration":1200,"delay":160,"initValues":{"translateY":50,"opacity":0},"animations":{"translateY":0,"opacity":1}}'>
						...
						<header class="fancy-title mb-60">
							...
							<h6 class="text-uppercase ltr-sp-2 font-size-12 font-weight-semibold text-secondary text_custom">OUR COMMUNITY</h6>
						...
						<div class="explore_button">
							<a href="#" class="btn text-uppercase circle border-thin font-size-14 
								font-weight-semibold explore_button" data-localscroll="true" 
								data-localscroll-options='{"scrollBelowSection":true}' style="color:#fff;">
								<span>
		...
		<section id="pricing" class="vc_row pt-100 pb-110 bg-light">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="lqd-column col-md-6 col-md-offset-3">
						...
						<header class="fancy-title mb-70 text-center">
							<h1>PRICING</h1><br>
							<p>Following are the close estimates of our fees for differnet tasks. But we will provide the estimated project cost beforehand for your convinience.</p>
				...
				<div class="row">
					...
					<div class="lqd-column col-md-4">
						...
						<div class="pricing-table pricing-table-minimal">
							...
							<div class="pricing-table-header">
								<p><i>starts at</i></p>	
								<p class="pricing">
									<span class="text_custom"><i>$</i></span><span style="font-size: 100px; font-weight:bold; color:#EF7320;">10</span><small><i>/hour</i></small>
								</p>
					...
					<div class="lqd-column col-md-4">
						...
						<div class="pricing-table pricing-table-minimal">
							...
							<div class="pricing-table-header">
								<p><i>starts at</i></p>	
								<p class="pricing">
									<span class="text_custom"><i>$</i></span><span style="font-size: 100px; font-weight:bold; color:#EF7320;">15</span><small><i>/hour</i></small>
								</p>
							...
							<div class="pricing-table-footer">
								...
								<a href="#" class="btn btn-md btn-solid round lh-15 wide px-2" style="background-color:#EF7320; border: 1px solid #EF7320;">
									<span>
										<span class="btn-txt">Join Business Plan</span>
									</span>
								</a>
					...
					<div class="lqd-column col-md-4">
						...
						<div class="pricing-table pricing-table-minimal">
							...
							<div class="pricing-table-header">
								<p><i>starts at</i></p>	
								<p class="pricing">
									<span class="text_custom"><i>$</i></span><span style="font-size: 100px; font-weight:bold; color:#EF7320;">20</span><small><i>/hour</i></small>
								</p>
							...
							<div class="pricing-table-body">
								...
								<ul>
									<li>Mobile Application Development (iOS/Android)</li><br>
								</ul>
					...
					<div class="col-12 terms" style="text-align:right;"><i>* terms & conditions apply.
					</i></div>
				</div><!-- /.row -->
				...
				<div class="row">
					...
					<div class="lqd-column col-lg-4 col-md-12" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":"all-childs","duration":1200,"delay":160,"initValues":{"translateY":50,"opacity":0},"animations":{"translateY":0,"opacity":1}}'>
						...
						<header class="fancy-title mb-130">
							...
							<h6 class="text-uppercase ltr-sp-2 font-size-12 font-weight-semibold text-secondary text_custom">TESTIMONIALS</h6>
							<h2 class="mt-4 mb-4">WHAT OUR CLIENT SAYS</h2>
							<p>We all believe in strong work ethics, thus we do our best to reflect that belief in our work. Our numerous happy & satisfied customers are the testimonial to that fact.</p>
								...
								<div class="carousel-item is-active">
									...
									<div class="testimonial testimonial-whole-filled testimonial-whole-shadowed text-left testimonial-details-sm testimonial-avatar-sm">
										...
										<div class="testimonial-details">
											<figure class="avatar ">
												<img src="images/client_1.jpg" alt="Suke Tran">
											</figure>
											<div class="testimonial-info">
												<h5>Thomas Minarik,</h5>
										...
										<div class="testimonial-quote">
											<blockquote>
												<p class="font-size-16 lh-185">“Great quality work as always and impeccable support!! A++”</p>
											</blockquote>
										</div><!-- /.testimonial-quote -->
										<div class="testimonial-details">
											<figure class="avatar ">
												<img src="images/client_2.jpg" alt="Suke Tran">
											</figure>
											<div class="testimonial-info">
												<h5>Kris Ward,</h5>
										...
										<div class="testimonial-quote">
											<blockquote>
												<p class="font-size-16 lh-185">“Excellent Service”</p>
											</blockquote>
										</div><!-- /.testimonial-quote -->
										<div class="testimonial-details">
											<figure class="avatar ">
												<img src="images/client_3.jpg" alt="Suke Tran">
											</figure>
											<div class="testimonial-info">
												<h5>Ashley Stallworth,</h5>
												<h6 class="font-weight-normal">United States</h6>
											</div><!-- /.testimonial-info -->
											<time datetime="2017-07-07" class="text-uppercase">Now</time>
										</div><!-- /.testimonial-details -->
										<div class="testimonial-quote">
											<blockquote>
												<p class="font-size-16 lh-185">“Good web production skill sets”</p>
											</blockquote>
										</div><!-- /.testimonial-quote -->
										<div class="testimonial-details">
											<figure class="avatar ">
												<img src="images/client_4.jpg" alt="Suke Tran">
											</figure>
											<div class="testimonial-info">
												<h5>Phil Lascala,</h5>
												<h6 class="font-weight-normal">Australia</h6>
											</div><!-- /.testimonial-info -->
											<time datetime="2017-07-07" class="text-uppercase">Now</time>
										</div><!-- /.testimonial-details -->
										<div class="testimonial-quote">
											<blockquote>
												<p class="font-size-16 lh-185">“Very helpful in providing feedback to ensure we get the best for our project.”</p>
											</blockquote>
										</div><!-- /.testimonial-quote -->
									</div><!-- /.testimonial -->
							...
							<div class="liquid-blog-grid row">
								...
								<div class="lqd-column col-md-4">
									<article class="liquid-lp">
										<figure class="liquid-lp-media rounded">
											<a href="#">
												<img src="images/work_1.jpg" alt="Blog Post">
											</a>
										</figure>
										<header class="liquid-lp-header">
											<h2 class="entry-title liquid-lp-title h5 text_one_hover">
								...
								<div class="lqd-column col-md-4">
									<article class="liquid-lp">
										<figure class="liquid-lp-media rounded">
											<a href="#">
												<img src="images/work_2.jpg" alt="Blog Post">
											</a>
										</figure>
										<header class="liquid-lp-header">
											<h2 class="entry-title liquid-lp-title h5 text_one_hover">
								...
								<div class="lqd-column col-md-4">
									<article class="liquid-lp category-news category-rounded">
										<figure class="liquid-lp-media rounded">
											<a href="#">
												<img src="images/work_5.jpg" alt="Blog Post">
											</a>
										</figure>
										<header class="liquid-lp-header">
											<h2 class="entry-title liquid-lp-title h5 text_one_hover">
					...
					<div class="lqd-column col-md-10 col-md-offset-1 text-center" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":"all-childs","duration":1200,"delay":100,"initValues":{"translateY":80,"opacity":0},"animations":{"translateY":0,"opacity":1}}'>
						...
						<header class="fancy-title fancy-title-big mb-6">
							<h2 data-split-text="true" data-split-options='{"type":"lines"}'>
								...
								<br>
								<span class="font-size-2-15x lh-15 text_custom" data-fittext="true" data-fittext-options='{ "maxFontSize": 70, "minFontSize": 40, "compressor": 0.5 }'>together</span>
							</h2>
						</header><!-- /.fancy-title -->

						<a href="#" class="btn btn-solid text-uppercase circle btn-bordered border-thin font-size-14 font-weight-semibold" data-localscroll="true" data-localscroll-options='{"scrollBelowSection":true}' style="background-color:#E57E25; border: 0px">
							<span>
				...
				<div class="container">
					<div class="row">
						...
						<div class="lqd-column col-md-6">
							...
							<h6 class="text-uppercase ltr-sp-2 font-size-12 font-weight-semibold text-secondary text_custom">CONTACT US</h6>
							<h2 class="h3 mt-0 mb-1">GET IN TOUCH!</h2>
							<p>If you have any query or need a quick quotation then please fill up the form & send to us! We will get back to you within 24 hours!</p>
							<hr class="mb-40">
							...
							<div class="row mb-20">
								...
								<div class="lqd-column col-sm-12">
									...
									<p class="font-size-16 text_custom">Address</p>
									<p class="font-size-15">Level 4,105 Sukrabad,<br/>
								...
								<div class="lqd-column col-sm-12">
									...
									<p class="font-size-16 text_custom">Call Us</p>
									<p class="font-size-15">+880 17 555 000 64 <br> info@tekhive.net</p>
						...
						<div class="lqd-column col-md-5 col-md-offset-1 text-center">
							...
							<div class="lqd-column-inner border-athens-gray pt-40 pb-35 px-5">
								...
								<div class="contact-form contact-form-inputs-underlined contact-form-button-block">
									<form action="mailcheck.php" method="post" novalidate="novalidate">
										<div class="row">
											<div class="col-md-12">
											...
											<div class="col-md-12">
												<input type="text" name="mobile" aria-required="true" aria-invalid="false" placeholder="Contact number" required>
											</div><!-- /.col-md-12 -->
											...
											<div class="col-md-12">
												<input type="submit" value="SEND MESSAGE" class="font-size-14 ltr-sp-2" style="background-color:#E57E25;">
											</div><!-- /.col-md-12 -->
										</div><!-- /.row -->
									</form>
			...
			<div class="container">
				<div class="row">
					...
					<div class="lqd-column col-md-6 col-md-offset-3 text-center">
						...
						<figure class="mb-40">
							<img src="tekhive.png" alt="Logo" style="width:30%;">
						</figure>

						<p>© Copyright 2019. TekHive. All Rights Reserved.</p>
